...
$fileLocation = '\\10.0.0.6\files\ads2020\ads_2020_shp_win_x64.exe'
...
$packageArgs = @{
  ...
  fileType      = 'exe'
  file         = $fileLocation
  softwareName  = 'Advanced Design System*'
  checksum      = '25112691DEFFFFA3CE6F42C1E86EEA1CBBE7FDDB05F2A061CE36C33285191F6A'
  checksumType  = 'sha256'
  # OTHERS
